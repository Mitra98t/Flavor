...
- This project is not meant to be a learning resource, but reather a learning
  platform; the idea of sharing this exeprience is guided by the hope that it
  will help others to learn from my mistakes and successes while learning
  from suggestions and critics along the way.
- This book will primarily show my reasoning process and the decisions I make
  about language design and implementation.
  I will try to keep the explenations linear and clear (don't make me promise)
- I will try to keep the code as clean and readable as possible, but I can not
...
can not focus on one thing for too long.
...
The first, and most predominant, choice is the language we will be using for the
development.
...
focus on types that, when you manage to get the program to compile, it will not
do what you expect while not giving you any errors.
I do not think that this is a problem, and even so, there are multiple languages
one could use for this project.
...
I want to understand the process of language desgin and implementation; the goal
...
The few listed prior are just what I _know_ that I want to tacke in this
journey.

The aesthetic of NovaScript is will be designed with the concern of consistency
in mind -- going back to [the decision to use
Rust in Some design choices](./introduction.md#some-design-choices).
I have tried a not so small a collection of languages, and I have found a series of  
elements that I like and that I do not like in the syntaxes I have learned.
